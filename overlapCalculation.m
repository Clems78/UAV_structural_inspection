function [no_overlap, overlapped_twice, overlapped_thrice, overlapped_elmts, area_overlaped] = overlapCalculation(nodes_list,ground_node, Mtar_filtered, C, centroid, rmaj, rmaj_fixed, normal, alpha_t, points, area_structure)
% Assess overlap
